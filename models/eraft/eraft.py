...
from models.eraft.utils import coords_grid, upflow8
from argparse import Namespace
from models.eraft_utils.image_utils import ImagePadder
...
class ERAFT(nn.Module):
    ...
    def forward(self, image1, image2, iters=12, flow_init=None, upsample=True):
        ...
        with autocast(enabled=self.args.mixed_precision,device_type='cuda'):
